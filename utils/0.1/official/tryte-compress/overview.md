...
In this example, we create and send a transaction on the [Devnet](root://getting-started/1.0/networks/overview.md). The Devnet is similar to the Mainnet, except the tokens are free. Any transactions that you send to the Devnet do not exist on other networks such as the Mainnet.
