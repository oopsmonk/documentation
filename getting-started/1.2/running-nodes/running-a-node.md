...
For a description of each node software as well as links to guides and tutorials for running them, see [Node software](root://node-software/1.0/overview.md).
...
See the [Node software](root://node-software/1.0/overview.md) documentation for guides and tutorials.
