...
| <a name="mwm"></a>`--mwm`|`MWM`|Set the [minimum weight magnitude](root://getting-started/1.1/first-steps/sending-transactions.md#doing-proof-of-work)|number|9|
...
|<a name="neighbors"></a>`-n`, `--neighbors` |`NEIGHBORS`|Set the URLs and IP addresses of [neighbors](../tutorials/find-neighbors.md) |array of strings |[""] |
