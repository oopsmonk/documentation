...
|`--depth`|Value to use for the [depth](root://getting-started/0.1/transactions/depth.md) argument of the [`getTransactionsToApprove`](root://iri/1.0/references/iri-api-reference.md#getTransactionsToApprove) endpoint|integer |3||
