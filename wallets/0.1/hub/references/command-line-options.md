...
|`--depth`|Value to use for the depth argument of the [`getTransactionsToApprove`](root://hornet/1.1/references/api-reference.md#getTransactionsToApprove) endpoint|integer |3||
