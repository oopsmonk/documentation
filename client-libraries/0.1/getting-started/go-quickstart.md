...
**In this quickstart, you learn the basics of IOTA development in Go, from setting up a development environment to listening for live transaction in the Tangle.**
...
All the packages are listed in the [Go GitHub repository](https://github.com/iotaledger/iota.go/).
