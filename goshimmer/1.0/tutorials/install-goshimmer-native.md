# Build the GoShimmer executable from source
...
## Step 1. Build the GoShimmer executable
...
## Step 2. Run the GoShimmer executable

1. Open the `config.json` file and replace the `enablePlugins` field with the following to enable the spammer API endpoint and the Tangle visualizer
...
2. Use one of the following commands to execute the `goshimmer` file, depending on your operating system:
